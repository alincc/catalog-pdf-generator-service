...
public class PageServiceTest {
	...
	public void findPageLocations() throws Exception {
		...
		List<PageLocationWrapper> expecteds = Arrays.asList(
				...
				new PageLocationWrapper("URN:NBN:no-nb_digibok_2013021509063_0008", "", new PageLocation(new URL("http://www.nb.no/services/image/resolver?url_ver=Z39.88-2004&rft_id=URN:NBN:no-nb_digibok_2013021509063_0008&svc_id=info:lanl-repo/svc/getRegion&svc_val_fmt=info:ofi/fmt:kev:mtx:jpeg2000&svc.format=image/jpeg&svc.level=1&svc.rotate=0"), new URL("http://appserv3.nb.no:8088/postman-pat/file/digibok_2013021509063_0008/alto/digibok_2013021509063_0008.xml"))),
				new PageLocationWrapper("URN:NBN:no-nb_digibok_2013021509063_0009", "", new PageLocation(new URL("http://www.nb.no/services/image/resolver?url_ver=Z39.88-2004&rft_id=URN:NBN:no-nb_digibok_2013021509063_0009&svc_id=info:lanl-repo/svc/getRegion&svc_val_fmt=info:ofi/fmt:kev:mtx:jpeg2000&svc.format=image/jpeg&svc.level=1&svc.rotate=0"), new URL("http://appserv3.nb.no:8088/postman-pat/file/digibok_2013021509063_0009/alto/digibok_2013021509063_0009.xml"))),
				new PageLocationWrapper("URN:NBN:no-nb_digibok_2013021509063_0010", "", new PageLocation(new URL("http://www.nb.no/services/image/resolver?url_ver=Z39.88-2004&rft_id=URN:NBN:no-nb_digibok_2013021509063_0010&svc_id=info:lanl-repo/svc/getRegion&svc_val_fmt=info:ofi/fmt:kev:mtx:jpeg2000&svc.format=image/jpeg&svc.level=1&svc.rotate=0"), new URL("http://appserv3.nb.no:8088/postman-pat/file/digibok_2013021509063_0010/alto/digibok_2013021509063_0010.xml")))
			);
        ...
        for (int i = 0; i < actuals.size(); i++ ) {
            assertEquals(actuals.get(i).getUrn(), expecteds.get(i).getUrn());
        }
	}
